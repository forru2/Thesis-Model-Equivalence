...
def test_robustness(model, X_tr, y_tr, measure= performance, measure_metric = accuracy_score, sensitive_feature_tr = None, n_folds = 5, **kwargs):
    ...
    for fold, (train_index, val_index) in enumerate(folds_indices):
        ...
        params = {'model': m, 'X_ts': X_val, 'y_true': y_val}
        ...
        if measure is performance and sensitive_feature_tr is None:
...
if __name__ == '__main__':
    ...
    model = load(r'C:\Users\franc\OneDrive\Magistrale\Thesis-Model-Equivalence\Models\german\german_rtc_1.joblib')
    ...
    test_robustness(model, X_tr, y_tr, measure = performance, metric = accuracy_score)
    test_robustness(model, X_tr, y_tr, measure = fn.fairness_explorer, metric = fn.selection_rate, sensitive_feature_tr = sensitive_feature_tr)
